...
def main():
    ...
    if uploaded_file is not None:
        ...
        prompt = f"You are an expert video sale letter copywriter sepecializing in White Hat organic SEO tactics. Based on the following website audit report: {info}, generate a Video Sales Letter script (VSL)."
